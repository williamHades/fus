...
<title>随访管理系统-登录界面</title>
	...
	<script type="text/javascript">
		function submitData(){
			$("#fm").form("submit",{
				url:"${pageContext.request.contextPath}/people/peopleLogin.action",
//				onSubmit:function(){
...
<body>
	...
	<div class="easyui-window" title="随访管理系统" data-options="modal:true,closable:false,collapsible:false,minimizable:false,maximizable:false" style="width: 400px;height: 280px;padding: 10px">
